...
const SearchBar = (props) => {
	...
	return (
		<div class="col-start-6 col-span-4 relative my-auto text-gray-600">
			<input
				class="border-1 w-full border-gray-300 bg-white h-10 px-5 pr-16 rounded-lg text-sm focus:outline-none"
				type="search"
				name="searchBox"
				id="searchBox"
				placeholder="Search"
